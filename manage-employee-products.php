...
<html>
    ...
    <body>
        ...
        <div class="form-popup" id="myForm">
            ...
            <form class="form-container" action="./employee/add-product-employee.php" method="post">
            <h1>Add Product</h1>
        ...
        <div class="form-popup" id="myEditForm">
            <form class="form-container" action="./employee/edit-product-employee.php?productid=" method="post">
            <h1>Edit Product</h1>
        ...
        <script>
            ...
            if (confirm("Are you sure you want to delete product "+ "'" + product + "'")) {
                location.replace("./employee/delete-product-employee.php?productid="+id);
            } else {
                location.replace("./manage-employee-products.php");
            }}
