...
<html>
    ...
    <body>
        ...
        <input class="float-right btnExport" type="button" id="btnExport" value="Export PDF" onclick="download()" />
...
<script>
    ...
    if (confirm("Are you sure you want to delete Sale "+ "'" + id + "'")) {
        location.replace("./delete-salereport.php?saleid="+id);
    } else {
        location.replace("./manage-reports.php");
    }}
...
<script>
    function download() {
        let pdf = new jsPDF('l', 'pt', [842, 1920]);
