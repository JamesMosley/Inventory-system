...
<html>
    ...
    <body>
        ...
        <div class="page-main select">
            ...
            <button class="add-btn" type="button" id="addBtn"><a href="./manage-customers.php" class="new-font">Add New Customer</a></button>
        </div>
        <div>&nbsp</div>
        ...
        <script>
            ...
            function addSale() {
                ...
                location.replace("./add-sale.php?customerid="+customer_id+"&totalamount="+total_amount+"&products="+all_products);
            }
