...
<html>
    ...
    <body>
        ...
        <div class="form-popup" id="myForm">
            <form class="form-container" action="./add-customer.php" method="post">
            <h1>Add Customer</h1>
        ...
        <div class="form-popup" id="myEditForm">
            <form class="form-container" action="./edit-customer.php?customerid=" method="post">
            <h1>Edit Customer</h1>
...
<script>
    ...
    if (confirm("Are you sure you want to delete Customer "+ "'" + customer + "'")) {
        location.replace("./delete-customer.php?customerid="+id);
    } else {
        location.replace("./manage-customers.php");
    }}
