...
<html>
    ...
    <body>
        ...
        <div class="form-popup" id="myForm">
            <form class="form-container" action="./add-category.php" method="post">
            <h1>Add Category</h1>
        ...
        <div class="form-popup" id="myEditForm">
            <form class="form-container" action="./edit-category.php?categoryid=" method="post">
            <h1>Edit Category</h1>
...
<script>
    ...
    if (confirm("Are you sure you want to delete Category "+ "'" + category + "'")) {
        location.replace("./delete-category.php?categoryid="+id);
    } else {
        location.replace("./manage-categories.php");
    }}
