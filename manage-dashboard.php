                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            ...
                            $total_users = mysqli_num_rows($total_users_result);
                            printf("%d\n", $total_users);
                            ?>
                            </span>
                            <br>
                            <!-- <span id="card-text-text">Registered Users</span> -->
                        </p>
                        <a href="./manage-users.php" class="btn btn-primary">Go to User Management</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="./manage-categories.php" class="btn btn-primary">View Categories</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="./manage-products.php" class="btn btn-primary">View Products</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="./manage-customers.php" class="btn btn-primary">View Customers</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="./manage-sales.php" class="btn btn-primary">Add Sales</a>
                    </div>
                </div>
            </div>
